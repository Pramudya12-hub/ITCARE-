@extends('layouts.app')
@section('title', 'Profile IT Support')

@section('content')
<div class="mb-4">
    <h4 class="fw-bold mb-1">Profile IT Support</h4>
...
<div class="card-custom">
    ...
    <form action="{{ route('support.profile.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="text-center mb-4">
            <img id="photoPreview"
                 src="{{ Auth::user()->profile_photo ? asset('storage/' . Auth::user()->profile_photo) : 'https://placehold.co/120x120?text=IT' }}"
