    ...
    <div class="col-md-8">
        ...
        <div class="card-custom mb-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <span class="small text-muted">Berdasarkan data ticket terbaru</span>
            </div>
            ...
            <div class="d-grid gap-2">
                <form action="{{ route('support.ai.summarize') }}" method="POST">
                    ...
                    <button type="submit"
                        ...
                        <div class="fw-bold mb-1">Rangkum 5 Ticket Terbaru</div>
                        <div class="text-muted small">
                            AI akan menganalisis pola masalah terbaru.
                        </div>
                    </button>
                </form>

                <button class="btn btn-white border rounded p-3 text-start small bg-white text-muted" disabled>
                    <div class="fw-bold mb-1">Cari Pola Masalah Printer</div>
                    <div class="small">Fitur AI berikutnya.</div>
                </button>

                <button class="btn btn-white border rounded p-3 text-start small bg-white text-muted" disabled>
                    <div class="fw-bold mb-1">Generate Artikel KB</div>
                    <div class="small">Fitur AI berikutnya.</div>
                </button>

                <button class="btn btn-white border rounded p-3 text-start small bg-white text-muted" disabled>
                    <div class="fw-bold mb-1">Suggest Kategori Otomatis</div>
                    <div class="small">Fitur AI berikutnya.</div>
                </button>
            </div>
        </div>
